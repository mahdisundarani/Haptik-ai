...
const Blog = () => {
    return (
        <div className='px-6 md:px-16 pt-6 pb-10'>
            ...
            <div className='bg-blue-700 rounded-md lg:rounded-3xl text-xl lg:text-3xl font-medium h-[200px] flex flex-col lg:flex-row justify-evenly items-center mt-10'>
