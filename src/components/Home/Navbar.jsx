    ...
    <div className=" mx-4 max-w-[1500px] ">
      ...
      <div className="flex justify-between xl:justify-evenly">
        ...
        <div className="hidden xl:flex items-center">
          <ul className="flex">
            <li
              ...
              className="text-lg px-4 py-3 font-medium hover:text-white hover:bg-[#00cccc] rounded-3xl"
            >
              Solution
              {isOpen && (
                <div className="absolute top-20 bg-white text-black py-4 shadow-lg w-[450px] px-6 rounded-3xl">
                  <h1 className=" font-medium">By Product</h1>
                  <div className="flex justify-between pt-4">
                    <div>
                      <h2 className="text-sm">
                        <Link to="/contakt">Contackt</Link>
                      </h2>
                      <h3 className="text-xs font-[300]">
                        Gen AI-Powered CX Suite
                      </h3>
                    </div>
                    <div>
            ...
            <li className="text-lg px-4 py-3 font-medium  hover:bg-[#00cccc] hover:text-white rounded-3xl">
              Platform
            </li>
            <li className="text-lg px-4 py-3 font-medium  hover:bg-[#00cccc] hover:text-white rounded-3xl">
              Resources
        ...
        <div className="hidden xl:flex">
          <button className="bg-blue-600 text-white h-10 w-full mr-3 sm:w-40 lg:w-40 xl:w-40 font-bold rounded-md ml-5 mt-6 ">
            <Link to="/login">Get A Demo</Link>
          </button>
        </div>
        {/* logic of toggle */}
        <div
          onClick={handleNav}
          className="xl:hidden mt-6 mr-10"
        >
      ...
      <div className="">
        <ul
          className={
            nav
              ? "m-3 mt-8 xl:hidden bg-white h-screen ease-in-out duration-500"
        ...
        >
          ...
          <button className="bg-blue-600 text-white h-10 w-full sm:w-40 lg:w-40 xl:w-40 font-bold rounded-md mx-auto mt-6">
            Get A Demo
          </button>
        </ul>
      </div>
